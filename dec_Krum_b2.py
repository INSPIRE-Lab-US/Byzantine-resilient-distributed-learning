# Decentralized learning with BRIDGE using Krum screening
...
for iteration in range(para.T):
    #Communication 
    para.communication(w_nodes, neighbors, sess, b = para.b, screen = True, goByzantine = True, screenMethod='Krum')
...
with open(f'./result/Krum/result_Krum_b2_{monte_trial}.pickle', 'wb') as handle:
